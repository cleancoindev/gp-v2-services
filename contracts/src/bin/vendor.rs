...
const NPM_CONTRACTS: &[(&str, &str)] = &[
    ...
    (
        "@gnosis.pm/gp-v2-contracts@0.0.1-alpha.2/deployments/rinkeby/GPv2Settlement.json",
        "GPv2Settlement.json",
    ),
    (
        "@gnosis.pm/gp-v2-contracts@0.0.1-alpha.2/deployments/rinkeby/GPv2AllowListAuthentication.json",
